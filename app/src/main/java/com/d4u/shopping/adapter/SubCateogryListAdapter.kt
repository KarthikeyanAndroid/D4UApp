...
//        Log.i(TAG, "onBindViewHolder: " + Gson().toJson(list))
    ...
    fun addItems(postItems: ArrayList<Customer>) {
...
//        return super.getItemViewType(position)
    ...
    inner class ViewHolder constructor(
            ...
            var list: ArrayList<Customer>, var iItemClickListener: IItemClickListenrer
    ) :

            RecyclerView.ViewHolder(binding.root), View.OnClickListener {

        fun bind(data: Customer, context: Context) {
...
//            binding.productImgview.setImageResource(data.business_logo)
        }
        ...
        override fun onClick(view: View?) {
            when (view) {
                ...
                binding.productImgview -> {
                    ...
                    iItemClickListener.itemClick(adapterPosition, view, "", list.get(adapterPosition).id.toString(), 1)
                    if (checkedPosition != adapterPosition) {
