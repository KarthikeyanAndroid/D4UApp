...
import com.d4u.shopping.databinding.ListItemSpecificOfferBinding
import java.util.*


class OfferDetailCateListAdapter(
        var list: ArrayList<MainCateogryModels>,
        var context: Context, var iItemClickListener: IItemClickListenrer
) :
    RecyclerView.Adapter<OfferDetailCateListAdapter.ViewHolder>() {

    private val TAG: String = javaClass.simpleName
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

        val listProductCateogryBinding =
            ListItemSpecificOfferBinding.inflate(LayoutInflater.from(context), parent, false)
...
//        Log.i(TAG, "onBindViewHolder: " + Gson().toJson(list))
    ...
    class ViewHolder constructor(
        val binding: ListItemSpecificOfferBinding,
